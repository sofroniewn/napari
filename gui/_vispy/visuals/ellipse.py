...
class EllipseVisual(PolygonVisual):
    ...
    **kwargs : dict
    ...
    def __init__(self, center=None, color='black', border_color=None,
        ...
        PolygonVisual.__init__(self, pos=None, color=self._color,
                               border_color=self._border_color,
                               border_width=self._border_width, **kwargs)
    ...
    def set_data(self, center=None, color='black', border_color=None,
                 border_width=1, radius=(0.1, 0.1), start_angle=0.,
                 span_angle=360., num_segments=100, **kwargs):
        """
        Set data for 2D ellipse
        Parameters
        ----------
        center : array
            Center of the ellipse
